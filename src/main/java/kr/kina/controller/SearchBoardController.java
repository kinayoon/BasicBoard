...
public class SearchBoardController {
	...
	public String modifyPaginPOST(SearchCriteria cri, BoardVO board, RedirectAttributes rttr)throws Exception {
	...
	public String registPOST(SearchCriteria cri, BoardVO board, RedirectAttributes rttr)throws Exception {
